...
// First two constraints will be UILayoutPriorityRequired
// Third constraint will be UILayoutPriorityDefaultHigh
// Fourth two constraints will be UILayoutPriorityDefaultLow
self.view => self.redView.left == self.view.left + 10
        => self.redView.right == self.view.right - 10
        ~~> self.redView.top == self.view.top + 30
        ~~~> self.redView.height == 100
